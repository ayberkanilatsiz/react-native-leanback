...
public class LeanbackGrid1ColManager extends BaseGridManager {
    private static final String REACT_CLASS = "LeanbackGrid1Col";
    ...
    public LeanbackGridLayout createViewInstance(ThemedReactContext context) {
        ...
        LeanbackGridLayout leanbackGridLayout = new LeanbackGridLayout(context, gridFragment, 1);
